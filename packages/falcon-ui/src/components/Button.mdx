...
import { Button, GridLayout, Icon } from '../';

<ThemePreview of={Button}/>

`Button` component by default renders as `<button>` and accepts all of the `button` props (`onClick` etc) as well as all of the [responsive, theme-based style props](/responsive-props).
